  ...
  <div className="px-12 py-24">
    ...
    <Button variant="primary" size="lg">Get started <ArrowRight /></Button>
      ...
      <DocSection id="shadow" title="Shadow Options">
        <p className="text-sm text-muted-foreground"><code className="text-xs bg-muted px-1.5 py-0.5 rounded">globeShadowAngle</code> controls which side is sparse. <code className="text-xs bg-muted px-1.5 py-0.5 rounded">globeShadowStrength</code> (0–1) controls the fade.</p>
      ...
      <DocSection id="notes" title="Notes">
        <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
          ...
          <li>When motion is disabled, the globe renders as a static snapshot.</li>
          <li>Do not nest Hero inside a <code className="text-xs bg-muted px-1.5 py-0.5 rounded">Container</code> — it is designed to be full-width.</li>
        </ul>
      </DocSection>
